...
<body class="bg-indigo-950 rounded-lg">
        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            <a href="inicio.php" class="bg-indigo-600 text-indigo-100 rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Início</a>
                            ...
                            <a href="categorias.php" class="text-indigo-400 hover:bg-indigo-700 hover:text-indigo-100 rounded-md px-3 py-2 text-sm font-medium">Categorias</a>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2  sm:static sm:inset-auto sm:ml-6 sm:pr-0 ">
                    <a class=" block font-medium py-2 text-sm text-indigo-200  hover:text-indigo-50 rounded-sm" role="menuitem" tabindex="-1" id="user-menu-item-0">Administrador</a>
    ...
    <div class="mt-52">
        <h1 class="mb-7 text-4xl text-center font-bold text-indigo-300">Olá! Seja bem-vindo(a) ao <span class="text-indigo-100">Controle de Estoque de Móveis</span>!</h1>

        <div class="pt-4">
            <h4 class="text-center font-semibold text-indigo-300 ">Deseja consultar o estoque da sua loja? <a href="meuEstoque.php" class="h-16 w-full px-6 py-5 mb-6 ml-3 text-md font-bold leading-none text-white transition duration-300 md:w-96 rounded-2xl hover:bg-indigo-600 focus:ring-4 focus:ring-indigo-300 bg-indigo-800">Quero consultar meu estoque</a></h4>
        </div>
        
    </div>

    <!-- <div class="mt-40 ">
        <h1 class="mb-4 text-4xl font-bold text-indigo-300">O que é esse sistema?</h1>
        <h4 class="flex text-justify font-semibold text-indigo-300 ">Esse sistema é um Controle de estoque de móveis e é uma ferramenta de software utilizada para gerenciar e monitorar o inventário de produtos, neste caso, móveis, em uma empresa. Ele ajuda a garantir que os níveis de estoque sejam mantidos de forma eficiente, evitando tanto a falta de produtos quanto o excesso de mercadorias armazenadas. </h4>
    </div> -->
