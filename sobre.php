...
<body class="bg-indigo-950 rounded-lg">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="sobre.php" class="bg-indigo-600 text-indigo-100 rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Sobre</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="mx-32 mt-24">
        ...
        <p class="mb-2 text-lg font-normal text-gray-500 dark:text-indigo-100">Ele ajuda a garantir que os níveis de estoque sejam mantidos de forma eficiente, evitando tanto a falta de produtos quanto o excesso de mercadorias armazenadas. </p>
        <p class="mb-4 text-lg font-normal text-gray-500 dark:text-indigo-100">Aqui você pode consultar o estoque da sua loja, cadastrar produtos, fazer atualizações nos produtos e removê-los. </p>
        <a href="inicio.php" class="mb-5 inline-flex items-center text-lg text-blue-600 dark:text-indigo-400 hover:underline">
